...
function footer(){
  ...
  if(!bubble){
    ...
    bubble.innerHTML='<span id="footer-established">© 2026 GAMINGPIG</span><span aria-hidden="true">•</span><span id="footer-version-label">v24.186.0</span><span aria-hidden="true">•</span><button id="footer-menu-toggle-btn" type="button" aria-expanded="false"><span id="footer-more-label">Mehr</span> <span id="footer-menu-arrow">▲</span></button>';
