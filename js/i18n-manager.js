        ...
        constructor() {
            ...
            this.translations = {
                de: {
                    ...
                    privacy_modal_date: "Stand: 4. September 2026",
                    privacy_modal_intro: "Wir haben unsere <strong class=\"text-white\">Datenschutzerklärung</strong> transparent erweitert:",
                    privacy_modal_item1: "<strong class=\"text-slate-200\">Mehrsprachiges Songtext-Vorlesen:</strong> Lokale Spracherkennung (u. a. Schwedisch für Marcus & Martinus, Norwegisch, Deutsch, Englisch).",
                    privacy_modal_item2: "<strong class=\"text-slate-200\">Einstellbares Vorlesetempo:</strong> Anpassbare Geschwindigkeiten (0.8x bis 2.0x) für alle Audio-Elemente.",
                    privacy_modal_item3: "<strong class=\"text-slate-200\">Keine Datenübertragung:</strong> Sämtliche Einstellungen verbleiben rein lokal in deinem Browser.",
                ...
                en: {
                    ...
                    privacy_modal_date: "As of: September 4, 2026",
                    privacy_modal_intro: "We have updated our <strong class=\"text-white\">privacy policy</strong> transparently:",
                    privacy_modal_item1: "<strong class=\"text-slate-200\">Multilingual Lyrics Read-Aloud:</strong> Local language recognition (e.g. Swedish for Marcus & Martinus, Norwegian, German, English).",
                    privacy_modal_item2: "<strong class=\"text-slate-200\">Adjustable Speech Rate:</strong> Configurable speeds (0.8x to 2.0x) for all audio elements.",
                    privacy_modal_item3: "<strong class=\"text-slate-200\">No Data Transmission:</strong> All settings remain strictly local within your browser.",
                ...
                es: {
                    ...
                    privacy_modal_date: "A partir de: 4 de septiembre de 2026",
                    privacy_modal_intro: "Hemos ampliado nuestra <strong class=\"text-white\">política de privacidad</strong> con total transparencia:",
                    privacy_modal_item1: "<strong class=\"text-slate-200\">Lectura de letras multilingüe:</strong> Reconocimiento de idioma local (p. ej. sueco para Marcus & Martinus, noruego, alemán, inglés).",
                    privacy_modal_item2: "<strong class=\"text-slate-200\">Velocidad de voz ajustable:</strong> Velocidades configurables (0.8x a 2.0x) para elementos de audio.",
                    privacy_modal_item3: "<strong class=\"text-slate-200\">Sin transferencia de datos:</strong> Todas las preferencias permanecen localmente en tu navegador.",
                ...
                fr: {
                    ...
                    privacy_modal_date: "Date : 4 septembre 2026",
                    ...
                    privacy_modal_item1: "<strong class=\"text-slate-200\">Lecture vocale multilingue des paroles :</strong> Reconnaissance linguistique locale (ex. suédois pour Marcus & Martinus, norvégien, allemand, anglais).",
                    privacy_modal_item2: "<strong class=\"text-slate-200\">Vitesse de lecture ajustable :</strong> Vitesses configurables (0.8x à 2.0x) pour tous les éléments audio.",
                    privacy_modal_item3: "<strong class=\"text-slate-200\">Aucune transmission de données :</strong> Tous les paramètres restent strictement en local dans ton navigateur.",
                ...
                pt: {
                    ...
                    privacy_modal_date: "Em: 4 de setembro de 2026",
                    privacy_modal_intro: "Atualizamos nossa <strong class=\"text-white\">política de privacidade</strong> de forma transparente:",
                    privacy_modal_item1: "<strong class=\"text-slate-200\">Leitura de letras multilíngue:</strong> Reconhecimento local de idioma (ex.: sueco para Marcus & Martinus, norueguês, alemão, inglês).",
                    privacy_modal_item2: "<strong class=\"text-slate-200\">Velocidade de leitura ajustável:</strong> Velocidades configuráveis (0.8x a 2.0x) para áudios.",
                    privacy_modal_item3: "<strong class=\"text-slate-200\">Sem transferência de dados:</strong> Todas as configurações ficam estritamente locais no navegador.",
                ...
                tr: {
                    ...
                    privacy_modal_date: "Tarih: 4 Eylül 2026",
                    privacy_modal_intro: "Gizlilik politikamızı şeffaf bir şekilde güncelledik:",
                    privacy_modal_item1: "<strong class=\"text-slate-200\">Çok Dilli Şarkı Sözü Okuma:</strong> Yerel dil tanıma (ör. Marcus & Martinus için İsveççe, Norveççe, Almanca, İngilizce).",
                    privacy_modal_item2: "<strong class=\"text-slate-200\">Ayarlanabilir Okuma Hızı:</strong> Tüm ses ögeleri için özelleştirilebilir hızlar (0.8x - 2.0x).",
                    privacy_modal_item3: "<strong class=\"text-slate-200\">Veri Aktarımı Yok:</strong> Tüm ayarlar tamamen yerel olarak tarayıcında saklanır.",
